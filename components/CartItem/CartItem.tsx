  ...
  return (
    <>
      <div className="relative">
        <button type="button" onClick={openModal} aria-label="Carrinho">
        ...
        >
          <div className="min-h-screen text-right">
            ...
            >
              <div
                style={{ height: "100vh" }}
                className="relative inline-block h-screen w-full max-w-md overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl"
              >
                {/* Header */}
